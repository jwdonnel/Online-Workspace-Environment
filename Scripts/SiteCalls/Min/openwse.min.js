            ...
            url: openWSE.siteRoot() + "WebServices/AcctSettings.asmx/GetUserOverlays", type: "POST", data: "{ }", contentType: "application/json; charset=utf-8", success: function (e) {
                var a = ""; if (null != e.d) {
                    a += "<div class='add-rss-list-header'>Available Overlays</div>"; for (var t = 0; t < e.d.length; t++) {
                        var i = "Add Overlay", n = ""; openWSE.ConvertBitToBoolean(e.d[t][3]) && (i = "Remove Overlay", n = "add-rss-list-item-hasitem");
                        var o = "<table width='100%'><tr><td style='width: 170px;'><div class='pad-right-big'>" + e.d[t][0] + "</div></td><td align='left'>" + e.d[t][2] + "</td></tr></table>"; a += "<div class='add-rss-list-item " + n + "' title='" + i + "' onclick=\"openWSE.AddRemoveOverlayClick('" + e.d[t][1] + "', this);\">" + o + "</div>"
