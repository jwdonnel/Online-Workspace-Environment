...
namespace OpenWSE_Tools.Notifications {
    ...
    public class Notifications {
        ...
        public void GetNotifications() {
            ...
            List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("Notifications", "", query, "NotificationName ASC");
        ...
        public Notifications_Coll GetNotification(string _id) {
            ...
            List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("Notifications", "", query);
            foreach (Dictionary<string, string> row in dbSelect) {
                string id = row["ID"];
                string nn = row["NotificationName"];
                string ni = row["NotificationImage"];
        ...
        public void DeleteNotification(string id) {
            dbCall.CallDelete("Notifications", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        }
        ...
        public void GetUserNotifications(string userName) {
            ...
            List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("aspnet_UserNotifications", "NotificationID, Email", new List<DatabaseQuery>() { new DatabaseQuery("UserName", userName), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
            foreach (Dictionary<string, string> row in dbSelect) {
        ...
        public bool IsUserNotificationEnabled(string username, string notifiId) {
            List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("aspnet_UserNotifications", "Email", new List<DatabaseQuery>() { new DatabaseQuery("UserName", username.ToLower()), new DatabaseQuery("NotificationID", notifiId), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
            if (dbSelect.Count > 0) {
                return true;
            }
        ...
        public void DeleteUserNotification(string username, string notifiId) {
            dbCall.CallDelete("aspnet_UserNotifications", new List<DatabaseQuery>() { new DatabaseQuery("NotificationID", notifiId), new DatabaseQuery("UserName", username.ToLower()), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        }

        public void DeleteAllUserNotification(string username) {
            dbCall.CallDelete("aspnet_UserNotifications", new List<DatabaseQuery>() { new DatabaseQuery("UserName", username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        }
