...
public class DBImporter_Coll
{
    ...
    public DBImporter_Coll(string id, string tableId, string date, string tn, string description, string cs, string sc, string p, string ib, string allowEdit, string usersAllowedToEdit, string notifyUsers, string columnOverrides, string tableCustomizations) {
        _id = id;
        _tableId = tableId;
        _date = date;
        _tn = tn;
    ...
    public DBImporter_Coll(string id, string tableId, string date, string tn, string description, string cs, string sc, string p, string ib, string allowEdit, string usersAllowedToEdit, string notifyUsers, string columnOverrides, List<CustomTableCustomizations> tableCustomizations) {
        _id = id;
        _tableId = tableId;
        _date = date;
        _tn = tn;
    ...
    public Dictionary<string, string> ColumnOverrides {
        get {
            try {
                ...
                DBImporter_Coll _tempColl = new DBImporter_Coll(_id, _tableId, _date, _tn, _description, _cs, _sc, _p, _ib, _allowEdit, String.Join(ServerSettings.StringDelimiter, _usersAllowedToEdit), _notifyUsers.ToString(), co, _tableCustomizations);
...
public class DBImporter {
    ...
    public void AddImport(string tableId, string tn, string desc, string cs, string sc, string p, string ib, bool allowEdit, string usersAllowedToEdit, bool notifyUsers, string columnOverrides, string tableCustomizations) {
    ...
    public void GetImportList() {
        ...
        foreach (Dictionary<string, string> entry in dbSelect) {
            ...
            DBImporter_Coll coll = new DBImporter_Coll(id, tableID, date, tableName, description, connString, selectCommand, provider, importedBy, allowEdit, usersAllowedToEdit, notifyUsers, columnOverrides, tableCustomizations);
            _coll.Add(coll);
        }
    }
    ...
    public DBImporter_Coll GetImportTableByTableId(string tableId) {
        ...
        foreach (Dictionary<string, string> entry in dbSelect) {
            ...
            coll = new DBImporter_Coll(id, tableId, date, tableName, description, connString, selectCommand, provider, importedBy, allowEdit, usersAllowedToEdit, notifyUsers, columnOverrides, tableCustomizations);
            break;
        }
