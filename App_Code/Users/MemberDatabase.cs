...
public class MemberDatabase {
    ...
    public void AddUserCustomizationRow(string username) {
        ...
        if (_drDefaults != null && _drDefaults.Count > 0 && !string.IsNullOrEmpty(UserId)) {
            ...
            query.Add(new DatabaseQuery("SidebarAccordionMutliOpenAllowed", _drDefaults["SidebarAccordionMutliOpenAllowed"]));
            ...
            query.Add(new DatabaseQuery("SidebarAccordion", _drDefaults["SidebarAccordion"]));
            query.Add(new DatabaseQuery("ShowTopSearch", _drDefaults["ShowTopSearch"]));
            query.Add(new DatabaseQuery("NoBGOnAppRemote", _drDefaults["NoBGOnAppRemote"]));
            query.Add(new DatabaseQuery("AppRemoteForeColor", _drDefaults["AppRemoteForeColor"]));
            ...
            query.Add(new DatabaseQuery("UseAltSidebarTheme", _drDefaults["UseAltSidebarTheme"]));
            query.Add(new DatabaseQuery("TopbarTransparencyMode", _drDefaults["TopbarTransparencyMode"]));
            query.Add(new DatabaseQuery("SidebarTransparencyMode", _drDefaults["SidebarTransparencyMode"]));
            query.Add(new DatabaseQuery("ShowSiteToolsPageDescription", _drDefaults["ShowSiteToolsPageDescription"]));
            query.Add(new DatabaseQuery("ShowSiteToolsIcons", _drDefaults["ShowSiteToolsIcons"]));
            query.Add(new DatabaseQuery("HideSidebarMenuIcons", _drDefaults["HideSidebarMenuIcons"]));
    ...
    public void UpdateSidebarAccordionMutliOpenAllowed(bool enable) {
        int temp = 0;
        if (enable) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("SidebarAccordionMutliOpenAllowed", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("SidebarAccordionMutliOpenAllowed", temp.ToString());
        }
    }
    ...
    public void UpdateSidebarAccordion(bool enable) {
        int temp = 0;
        if (enable) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("SidebarAccordion", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("SidebarAccordion", temp.ToString());
        }
    }
    public void UpdateShowTopSearch(bool show) {
        int temp = 0;
        if (show) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("ShowTopSearch", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("ShowTopSearch", temp.ToString());
        }
    }
    public void UpdateNoBGOnAppRemote(bool show) {
        int temp = 0;
        if (show) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("NoBGOnAppRemote", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("NoBGOnAppRemote", temp.ToString());
        }
    }
    public void UpdateAppRemoteForeColor(string color) {
        List<DatabaseQuery> query = new List<DatabaseQuery>();
        query.Add(new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID));
        query.Add(new DatabaseQuery("UserName", _username));

        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("AppRemoteForeColor", color.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("AppRemoteForeColor", color.ToString());
        }
    }
    ...
    public void UpdateUseAltSidebarTheme(bool enable) {
        int temp = 0;
        if (enable) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("UseAltSidebarTheme", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("UseAltSidebarTheme", temp.ToString());
        }
    }
    public void UpdateTopbarTransparencyMode(bool enable) {
        int temp = 0;
        if (enable) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("TopbarTransparencyMode", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("TopbarTransparencyMode", temp.ToString());
        }
    }
    public void UpdateSidebarTransparencyMode(bool enable) {
        int temp = 0;
        if (enable) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("SidebarTransparencyMode", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("SidebarTransparencyMode", temp.ToString());
        }
    }
    ...
    public void UpdateShowSiteToolsIcons(bool show) {
        int temp = 0;
        if (show) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("ShowSiteToolsIcons", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("ShowSiteToolsIcons", temp.ToString());
        }
    }
    public void UpdateHideSidebarMenuIcons(bool hide) {
        int temp = 0;
        if (hide) {
            temp = 1;
        }
        ...
        List<DatabaseQuery> updateQuery = new List<DatabaseQuery>();
        updateQuery.Add(new DatabaseQuery("HideSidebarMenuIcons", temp.ToString()));

        if (dbCall.CallUpdate(_userCustomizeTable, updateQuery, query)) {
            UpdateUsersTable("HideSidebarMenuIcons", temp.ToString());
        }
    }
    ...
    private bool CheckAndCreateUserSettings() {
        ...
        if (!UsersTable.ContainsKey(_username) && !string.IsNullOrEmpty(_username)) {
            List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(_usersTableName, "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
            if (dbSelect.Count > 0) {
                try {
                    if (!UsersTable.ContainsKey(_username) && !string.IsNullOrEmpty(_username)) {
                        ...
                        dbSelect = dbCall.CallSelect(_userCustomizeTable, "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
                        AddUserSettingToTable(dbSelect);

                        if (!string.IsNullOrEmpty(UsersTable[_username]["UserId"])) {
                            dbSelect = dbCall.CallSelect(_membershipTableName, "Email, CommentDate, ReceiveAllMail, EnabledApps, AdminPages, ActivationCode", new List<DatabaseQuery>() { new DatabaseQuery("UserId", UsersTable[_username]["UserId"]), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
                            AddUserSettingToTable(dbSelect);
                        }
                    }
                }
    ...
    public bool ReceiveAll {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("ReceiveAllMail")) {
    ...
    public List<string> ChattableUserList(string username) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(_usersTableName + ", " + _membershipTableName, "UserName", selectCols, new List<DatabaseQuery>() { new DatabaseQuery("UserName", username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public string GetUsernameFromUserId(string userId) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle(_usersTableName, "UserName", new List<DatabaseQuery>() { new DatabaseQuery("UserId", userId), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public bool AutoHideMode {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("AutoHideMode")) {
                string val = UsersTable[_username]["AutoHideMode"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("AutoHideMode")) {
                    val = GroupDefaults["AutoHideMode"];
                }
    ...
    public bool PresentationMode {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("PresentationMode")) {
                string val = UsersTable[_username]["PresentationMode"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("PresentationMode")) {
                    val = GroupDefaults["PresentationMode"];
                }
    ...
    public bool HideAppIcon {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("HideAppIcon")) {
                if (_username.ToLower() == ServerSettings.AdminUserName.ToLower()) {
                    return false;
                }
                else {
                    string val = UsersTable[_username]["HideAppIcon"];
                    if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("HideAppIcon")) {
                        val = GroupDefaults["HideAppIcon"];
                    }
    ...
    public bool ShowTopSearch {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("ShowTopSearch")) {
                string val = UsersTable[_username]["ShowTopSearch"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("ShowTopSearch")) {
                    val = GroupDefaults["ShowTopSearch"];
                }
    ...
    public bool NoBGOnAppRemote {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("NoBGOnAppRemote")) {
                string val = UsersTable[_username]["NoBGOnAppRemote"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("NoBGOnAppRemote")) {
                    val = GroupDefaults["NoBGOnAppRemote"];
                }
    ...
    public string AppRemoteForeColor {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("AppRemoteForeColor")) {
                string val = UsersTable[_username]["AppRemoteForeColor"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("AppRemoteForeColor")) {
                    val = GroupDefaults["AppRemoteForeColor"];
                }
    ...
    public bool UseAltSidebarTheme {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("UseAltSidebarTheme")) {
                string val = UsersTable[_username]["UseAltSidebarTheme"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("UseAltSidebarTheme")) {
                    val = GroupDefaults["UseAltSidebarTheme"];
                }
    ...
    public bool TopbarTransparencyMode {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("TopbarTransparencyMode")) {
                string val = UsersTable[_username]["TopbarTransparencyMode"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("TopbarTransparencyMode")) {
                    val = GroupDefaults["TopbarTransparencyMode"];
                }
    ...
    public bool SidebarTransparencyMode {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("SidebarTransparencyMode")) {
                string val = UsersTable[_username]["SidebarTransparencyMode"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("SidebarTransparencyMode")) {
                    val = GroupDefaults["SidebarTransparencyMode"];
                }
    ...
    public bool ShowSiteToolsIcons {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("ShowSiteToolsIcons")) {
                string val = UsersTable[_username]["ShowSiteToolsIcons"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("ShowSiteToolsIcons")) {
                    val = GroupDefaults["ShowSiteToolsIcons"];
                }
    ...
    public bool HideSidebarMenuIcons {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("HideSidebarMenuIcons")) {
                string val = UsersTable[_username]["HideSidebarMenuIcons"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("HideSidebarMenuIcons")) {
                    val = GroupDefaults["HideSidebarMenuIcons"];
                }
    ...
    public bool SidebarAccordionMutliOpenAllowed {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("SidebarAccordionMutliOpenAllowed")) {
                string val = UsersTable[_username]["SidebarAccordionMutliOpenAllowed"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("SidebarAccordionMutliOpenAllowed")) {
                    val = GroupDefaults["SidebarAccordionMutliOpenAllowed"];
                }
    ...
    public bool SidebarAccordion {
        get {
            if (CheckAndCreateUserSettings() && UsersTable[_username].ContainsKey("SidebarAccordion")) {
                string val = UsersTable[_username]["SidebarAccordion"];
                if (GroupDefaults.Count > 0 && GroupDefaults.ContainsKey("SidebarAccordion")) {
                    val = GroupDefaults["SidebarAccordion"];
                }
    ...
    public void DeleteUserCustomizations(string userName) {
        dbCall.CallDelete(_userCustomizeTable, new List<DatabaseQuery>() { new DatabaseQuery("UserName", userName), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
