...
public class PageViews {
    ...
    public void DeleteItemsByPageName(string pageName) {
        dbCall.CallDelete(TableName, new List<DatabaseQuery>() { new DatabaseQuery("PageName", pageName.ToLower()), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
