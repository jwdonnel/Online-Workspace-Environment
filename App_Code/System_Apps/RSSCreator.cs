...
public class RSSCreator
{
    ...
    public void Create(string groupName)
    {
        ...
        using (FileStream fs = File.Create(_serverLoc + "Apps\\MessageBoard\\RSS_Feeds\\" + groupName + ".rss"))
        {
            ...
            xtwFeed.WriteElementString("copyright", "Copyright " + ServerSettings.ServerDateTime.Year.ToString() + " " + OpenWSE.Core.Licensing.CheckLicense.SiteName + ". All rights reserved.");
