...
public class Bookmarks {
    ...
    public void GetBookmarks(string sortBy) {
        dataTable = dbCall.CallSelect("aspnet_UserBookmarks", "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) }, sortBy);
    }

    public string GetHTML_byID(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("aspnet_UserBookmarks", "BookmarkHTML", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public string GetHTMLName_byID(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("aspnet_UserBookmarks", "BookmarkName", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public string GetUsername_byID(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("aspnet_UserBookmarks", "UserName", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }
    ...
    public void deleteBookmark_byID(string id) {
        dbCall.CallDelete("aspnet_UserBookMarks", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }

    public void deleteBookmarks(string userName) {
        dbCall.CallDelete("aspnet_UserBookMarks", new List<DatabaseQuery>() { new DatabaseQuery("UserName", userName), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
    ...
    public void UpdateBookmark(string id, string name, string html) {
        ...
        dbCall.CallUpdate("aspnet_UserBookmarks", updateQuery, new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
}