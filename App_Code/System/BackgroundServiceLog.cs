...
namespace OpenWSE_Tools.Logging {
    ...
    public class BackgroundServiceLog {
        ...
        public List<BackgroundServicesLog_Coll> GetBackgroundServiceLogs(string fullNamespace) {
            ...
            List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(TableName, "", new List<DatabaseQuery>() { new DatabaseQuery("ServiceNamespace", fullNamespace), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) }, "DateAdded DESC");
