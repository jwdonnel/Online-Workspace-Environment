...
public class AppCategory {
    ...
    public AppCategory(bool getvalues) {
        if (getvalues) {
            dataTable = dbCall.CallSelect("AppCategory", "", new List<DatabaseQuery>() { new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) }, "Category ASC");
        }
    }
    ...
    public string GetCategoryName(string id) {
        ...
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppCategory", "Category", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public void updateItem(string category, string id) {
        ...
        dbCall.CallUpdate("AppCategory", updateQuery, new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        updateItemDate(id);
    }
    ...
    public bool deleteItem(string id) {
        return dbCall.CallDelete("AppCategory", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
