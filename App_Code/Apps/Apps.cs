...
public class App {
    ...
    public void CreateItem(string appid, string name, string filename, string icon, string ar, string am,
                           ...
                           bool autoOpen, string defaultWorkspace, bool isPrivate, bool allowUserOverrides, string appBackgroundColor, string iconBackgroundColor) {
        int h = 0;
        int w = 0;
    ...
    public string GetAppID(string name) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AppID", new List<DatabaseQuery>() { new DatabaseQuery("Name", name), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public string GetAppIDbyFilename(string name) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AppID", new List<DatabaseQuery>() { new DatabaseQuery("Filename", name), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public string GetAppCssClass(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "CssClass", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public bool GetAppAutoOpen(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AutoOpen", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public string GetCurrentworkspace(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "Workspace", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public bool GetAppMax(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "Maximized", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public string GetAppWidth(string id) {
        if (!string.IsNullOrEmpty(_username)) {
            DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "Width", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
            return dbSelect.Value;
        }
    ...
    public string GetAppHeight(string id) {
        if (!string.IsNullOrEmpty(_username)) {
            DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "Height", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
            return dbSelect.Value;
        }
    ...
    public bool GetClosedState(string id) {
        if (!string.IsNullOrEmpty(_username)) {
            DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "Closed", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
            return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
        }
    ...
    public Apps_Coll GetAppInformation(string appid) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("AppList", "", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> val in dbSelect) {
            ...
            if (string.IsNullOrEmpty(icon) || !File.Exists(ServerSettings.GetServerMapLocation + "Standard_Images/App_Icons/" + icon)) {
            ...
            db = new Apps_Coll(id, appID, appName, filename, icon, allowResize, allowMaximize, about, description, cssClass, autoLoad, autoFullScreen, category, minHeight, minWidth, createdBy, allowParams, allowPopOut, popOutLoc, overlayID, notificationID, autoOpen, defaultWorkspace, isPrivate, allowUserOverrides, appBackgroundColor, iconBackgroundColor);
            break;
        }
    ...
    public UserApps_Coll GetUserAppInformation(string appid) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("UserApps", "", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public string GetAppFilename(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "Filename", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public bool AllowMaximize(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AllowMaximize", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public bool AllowResize(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AllowResize", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public bool AllowParams(string appId) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AllowParams", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appId), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public bool GetAutoLoad(string AppID) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AutoLoad", new List<DatabaseQuery>() { new DatabaseQuery("AppID", AppID), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public bool GetAutoFullScreen(string AppID) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "AutoFullScreen", new List<DatabaseQuery>() { new DatabaseQuery("AppID", AppID), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public bool ItemInDatabase(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "AppID", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public bool ItemInDatabase(string user, string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "AppID", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", user), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        if (string.IsNullOrEmpty(dbSelect.Value)) {
            return false;
        }
        else {
    ...
    public bool ItemInDatabase_name(string name) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("UserApps", "AppID", new List<DatabaseQuery>() { new DatabaseQuery("AppName", name), new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        if (string.IsNullOrEmpty(dbSelect.Value)) {
            return false;
        }
        else {
    ...
    public void DeleteAppComplete(string id, string serverpath, bool deleteFiles = true) {
        ...
        dbCall.CallDelete("AppList", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
    ...
    public void DeleteAppLocal(string id) {
        dbCall.CallDelete("UserApps", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }

    public void DeleteAppLocal(string id, string username) {
        dbCall.CallDelete("UserApps", new List<DatabaseQuery>() { new DatabaseQuery("AppID", id), new DatabaseQuery("UserName", username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
    ...
    public string[] GetAppOverlayIds(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "OverlayID", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public string GetAppIconName(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "Icon", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        string icon = dbSelect.Value;
        if (string.IsNullOrEmpty(icon) || !File.Exists(ServerSettings.GetServerMapLocation + "Standard_Images/App_Icons/" + icon)) {
            icon = App.DefaultAppIcon;
        }
        return icon;
    ...
    public string GetAppName(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "Name", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public bool GetIsPrivate(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "IsPrivate", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public string GetAppCreatedBy(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "CreatedBy", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }

    public string GetAppNotificationID(string appid) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("AppList", "NotificationID", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appid), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        return dbSelect.Value;
    }
    ...
    public void GetUserInstalledApps() {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("UserApps", "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> row in dbSelect) {
    ...
    public UserApps_Coll GetUserInstalledApp_Coll(string appId) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("UserApps", "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("AppID", appId), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> row in dbSelect) {
            string id = row["ID"];
            string un = row["UserName"];
            string appID = row["AppID"];
    ...
    public List<object> GetUserOpenedApps(bool showDb) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("UserApps", "AppID, Workspace", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("Closed", "0"), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> row in dbSelect) {
            List<string> tempList = new List<string>();
            string appId = row["AppID"];
    ...
    public List<string> GetUserInstalledApp(string appId) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("UserApps", selectCols, new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("AppID", appId), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> row in dbSelect) {
            string Closed = row["Closed"];
            string Minimized = row["Minimized"];
            string Maximized = row["Maximized"];
    ...
    private void GetExtraAppInfo(string appId, ref List<string> list) {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("AppList", string.Empty, new List<DatabaseQuery>() { new DatabaseQuery("AppID", appId), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> val in dbSelect) {
            Dictionary<string, string> row = _userAppSettings.OverrideValues(val);
            string MinHeight = row["MinHeight"];
            string MinWidth = row["MinWidth"];
            ...
            else if (!string.IsNullOrEmpty(Filename) && !HelperMethods.IsValidHttpBasedAppType(Filename)) {
    ...
    public void GetUserSavedChatApps() {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("UserApps", "", "UserName=@UserName AND AppID LIKE 'app-ChatClient-%'", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
        foreach (Dictionary<string, string> row in dbSelect) {
            BuildUserAppColl(row, ref _dataTable_users);
        }
    }
    ...
    public void GetAllApps() {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("AppList", "", new List<DatabaseQuery>() { new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) }, "Name ASC");
        foreach (Dictionary<string, string> row in dbSelect) {
            Dictionary<string, string> overriddenRow = _userAppSettings.OverrideValues(row);
    ...
    public void GetAllAscxApps() {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("AppList", "", "LOWER(Filename) LIKE '%.ascx'", new List<DatabaseQuery>() { new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    ...
    public void DeleteUserProperties(string username) {
        dbCall.CallDelete("UserApps", new List<DatabaseQuery>() { new DatabaseQuery("UserName", username.Trim()), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }

    public void DeleteUserProperties() {
        dbCall.CallDelete("UserApps", new List<DatabaseQuery>() { new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
    }
    ...
    public string BuildAboutApp(string appId, string username) {
        ...
        if (appId.Contains("app-ChatClient-")) {
            ...
            str.Append("<div class='app-item-about'><div class='app-about-section'>" + imageIcon + "<div class='app-about-name'>Chat Client</div><div class='clear-space'></div></div>");
            ...
            str.Append("<div class='app-about-section'><div class='about-section-title'>About</div>" + OpenWSE.Core.Licensing.CheckLicense.SiteName + " - " + ServerSettings.ServerDateTime.Year + " John Donnelly</div>");
            #endregion
            ...
            if (db != null) {
                ...
                if (string.IsNullOrEmpty(about)) {
                    ...
                    about = OpenWSE.Core.Licensing.CheckLicense.SiteName + " | " + ServerSettings.ServerDateTime.Year + " | " + tempuser;
                }
                ...
                string sitePath = ServerSettings.GetSitePath(HttpContext.Current.Request);
                string imageIcon = "<img alt='icon' src='" + sitePath + "/Standard_Images/App_Icons/" + db.Icon + "' class='app-about-icon' />";
                ...
                str.Append("<div class='app-item-about'><div class='app-about-section'>" + imageIcon + "<div class='app-about-name'>" + db.AppName + "</div>");

                if (allowAppRating && !string.IsNullOrEmpty(_username) && _username.ToLower() != "demonologin") {
                    str.Append("<div class='app-rater-holder app-rater-" + db.AppId + "'></div>");
                }
                ...
                str.Append("<div class='app-about-category'>" + categoryNames + "</div></div>");
                ...
                if (appColor.ToLower() != "inherit") {
                    appColorBlock = "<div class='margin-right float-left boxshadow' style='height:14px; width: 14px; background-color: " + appColor + ";'></div>";
                }
                ...
                str.Append("<div class='about-property'><span class='property-title'>Icon Color</span><span class='property-value'>" + iconColor + "<div class='margin-right float-left boxshadow' style='height:14px; width: 14px; background-color: " + iconColor + ";'></div></span></div>");
