...
public class OverlayDLLs {
    ...
    public string GetFolderPath(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("aspnet_OverlayDLLs", "FolderPath", new List<DatabaseQuery>() { new DatabaseQuery("OverlayID", id), new DatabaseQuery("ApplicationId", ServerSettings.ApplicationID) });
