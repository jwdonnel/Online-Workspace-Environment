...
public partial class SiteTools_CreateAccount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack) {
            ...
            if (Page.User.Identity.IsAuthenticated) {
                CustomFonts.SetCustomValues(this.Page, new MemberDatabase(Page.User.Identity.Name));
            }
            else {
    ...
    protected void RegisterUser_CreatedUser(object sender, EventArgs e)
    {
        ...
        if (signUpConfirmEmail) {
            ...
            string link = "http:" + ServerSettings.GetSitePath(Request) + "/" + ServerSettings.DefaultStartupPage + "?ActivateUser=" + username + "&ActivationCode=" + code;
    ...
    {
        Page.Response.Redirect("~/SiteTools/iframes/CreateAccount.aspx");
    }
