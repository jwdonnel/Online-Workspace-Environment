<%@ page title="Network Log" async="true" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="SiteTools_NetworkLog, App_Web_txobhkq5" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                ...
                <div id="loginActivity" class="pnl-section" style="display: none;">
                    ...
                    <asp:Panel ID="pnl_autoDeleteLoginActivity" runat="server">
                        <div class="table-settings-box" style="margin-top: 0px;">
