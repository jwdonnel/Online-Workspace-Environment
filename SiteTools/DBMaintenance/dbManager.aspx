            ...
            <asp:Panel ID="DBMaintenance" runat="server">
                        ...
                        <div class="td-settings-ctrl">
                            <div class="float-left pad-bottom-big" style="width: 475px;">
                                ...
                                <asp:TextBox ID="tb_download_backup" runat="server" Text="Backup File Description"
                                    Width="300" CssClass="textEntry margin-right float-left" MaxLength="50" onfocus="if(this.value=='Backup File Description')this.value=''"
                                    onblur="if(this.value=='')this.value='Backup File Description'"></asp:TextBox>
                                <asp:LinkButton ID="lbtn_downloaddb" runat="server" OnClick="lbtn_downloaddb_Click" CssClass="input-buttons-create">Backup</asp:LinkButton>
                                <div class="clear">
                                </div>
                            </div>
                            <div class="float-left pad-bottom-big" style="width: 450px;">
                                <div class="clear">
                                </div>
                                ...
                                <asp:TextBox ID="tb_backup_databse" runat="server" Text="Backup File Description"
                                    Width="300" CssClass="textEntry margin-right float-left" MaxLength="50" onfocus="if(this.value=='Backup File Description')this.value=''"
                                    onblur="if(this.value=='')this.value='Backup File Description'"></asp:TextBox>
                                <asp:LinkButton ID="lbtn_buchat" runat="server" OnClick="lbtn_buchat_Click" CssClass="RandomActionBtns-backup-perform input-buttons-create"
                                    Text="Backup" />
                                <div class="clear">
                                </div>
                            </div>
                            ...
                            <div class="pad-bottom-big">
                                ...
                                <div class="clear-space-five"></div>
                                <asp:TextBox ID="tb_upload_desc" runat="server" Text="Upload File Description" CssClass="textEntry margin-right float-left"
                                ...
                                <asp:LinkButton ID="lbtn_uploaddb" runat="server" CssClass="RandomActionBtns input-buttons-create"
                            ...
                            <div class="clear-margin">
                                <span class="pad-right font-bold">Backups to show</span>
                                <asp:DropDownList ID="dd_backupstoshow" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dd_backupstoshow_SelectedIndexChanged">
                            ...
                            <asp:UpdatePanel ID="updatepnl_list" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="GV_BackupList" runat="server" CellPadding="0" CellSpacing="0" AutoGenerateColumns="False"
                                        ...
                                        AllowPaging="false" ShowHeaderWhenEmpty="True" Width="100%">
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <table class="myHeaderStyle" cellpadding="5" cellspacing="0" style="width: 100%;">
                                                        <tr>
                                                ...
                                                <ItemTemplate>
                                                    <table class="myItemStyle" cellpadding="5" cellspacing="0" style="width: 100%;">
                                                        <tr>
                                                            <td style="min-width: 150px; border-right: 1px solid #CCC; border-left: 1px solid #CCC;">
                                                                <%# XPath("Filename").ToString().Replace(ServerSettings.BackupFileExt, string.Empty) %>
                                                                <div class="clear-space-five">
                                                                </div>
                                ...
                                <Triggers>
                                    ...
                                    <asp:AsyncPostBackTrigger ControlID="dd_backupstoshow" />
                                </Triggers>
                            </asp:UpdatePanel>
                ...
                <asp:Panel ID="pnl_autobackstyem" runat="server" CssClass="pnl-section" ClientIDMode="Static" style="display: none;">
                    <div class="table-settings-box no-border">
                        ...
                        <div class="td-settings-desc">
                            To turn on/off the Auto Backup System, go to the Background Services page and start/stop service.
                        </div>
                    </div>
                </asp:Panel>
            </asp:Panel>
