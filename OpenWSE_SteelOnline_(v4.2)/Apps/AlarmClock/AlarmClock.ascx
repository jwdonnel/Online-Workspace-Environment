<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AlarmClock.ascx.cs" Inherits="Apps_AlarmClock_AlarmClock"
    ClientIDMode="Static" %>
<div id="alarmclock-load" class="main-div-app-bg">
    <asp:HiddenField ID="hf_currUser_AlarmClock" runat="server" />
    <div class="pad-all">
        <div id="alarm-time">
            12:00:00 AM
        </div>
        <a href="#" id="minimize-controls" onclick="return false;" style="font-size: 11px;">
            Collapse controls</a>
        <div class="clear-space-five">
        </div>
        <div id="setAlarm-holder">
            <h3 class="font-bold float-left margin-right">
                Alarm Time</h3>
            (Hour/Minute/Second)
            <div class="clear-space-five">
            </div>
            ...
            <a href="#" id="btn_setAlarm" class="input-buttons float-left" onclick="return false;"
                style="text-decoration: none!important;"><span class="td-update-btn float-left" style="padding: 0px!important;
                    margin-right: 5px!important;"></span>Set Alarm</a>
            <div class="float-left pad-top">
                <asp:RadioButton ID="rbAlarmOn" runat="server" GroupName="alarmOnOff" Text=" On"
