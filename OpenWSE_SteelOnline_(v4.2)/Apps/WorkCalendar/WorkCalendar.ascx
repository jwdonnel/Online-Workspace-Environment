...
<div id="workcalendar-load" class="main-div-app-bg">
    <div id="wCal-titlebar" class="pad-all app-title-bg-color" style="height: 40px">
        ...
        <a id="menubtn_employees" runat="server" href="#" class="menu-btns"
            onclick="LoadTypeEdit_wc('1');return false;">Employees</a> <a id="menubtn_reasons"
                runat="server" href="#" class="menu-btns" onclick="LoadTypeEdit_wc('2');return false;">Reasons</a> <a id="menubtn_requests" runat="server" href="#" class="menu-btns" onclick="LoadRequestApprovalModal();return false;">Requests</a><a id="printbtn" href="#" target="_blank" class="menu-btns">
                            ...
                            Hide Title/Search</a><span class="font-bold pad-right-sml pad-left-big">Calendar View:</span>
    ...
    <div class="Modal-overlay">
        <div class="Modal-element-align">
            <div class="Modal-element-modal">
                ...
                <div class="ModalPadContent">
                    <div id="Typelist_wc" style="max-height: 325px; overflow: auto;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="Modal-overlay">
        <div class="Modal-element-align">
            <div class="Modal-element-modal">
                ...
                <div class="ModalPadContent">
                    <div id="pendingapprovallist_wc" style="max-height: 325px; overflow: auto;">
                    </div>
                </div>
            </div>
        </div>
