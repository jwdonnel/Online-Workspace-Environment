...
<div id="personalcalendar-load" class="main-div-app-bg">
    <div id="pCal-titlebar" class="pad-all app-title-bg-color" style="height: 40px">
        ...
        <div class="float-right">
            <div id="searchwrapper" style="width: 300px;">
                ...
                <a href="#" title="Clear search" class="searchbox_clear" onclick="$('#tb_search_pcal').val('Search Current Month');onCalendarLoad();return false;">
                </a><a href="#" class="searchbox_submit" onclick="onCalendarLoad();return false;">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="pc-menu-bar">
        <a href="#" class="menu-btns" onclick="AddNewCalendarEvent_pc('', false);return false;">
            Add Event</a> <a href="#" class="menu-btns" onclick="HideTitleSearch_PC(this);return false;">
                Hide Title/Search</a>
                ...
                <div class="ModalHeader">
                    <div>
                        <div class="app-head-button-holder-admin">
                            <a href="#" onclick="ViewNewCalendarEvent_pc('');return false;" class="ModalExitButton">
                            </a>
                        </div>
        ...
        <div class="Modal-element-align">
            <div class="Modal-element-modal">
                <div class="ModalHeader">
                    <div>
                        <div class="app-head-button-holder-admin">
                            <a href="#" onclick="AddNewCalendarEvent_pc('', false);return false;" class="ModalExitButton">
                            </a>
                        </div>
                        <span class="Modal-title"></span>
                    </div>
                ...
                <div class="ModalPadContent">
                    <div class="pad-left pad-right font-bold float-left" style="width: 85px; padding-top: 4px;">
                        Title</div>
                    <input id="tb_newevent_title_pc" type="text" class="textEntry" maxlength="250" style="width: 300px;
                        border: 1px solid #CCC;" />
                    <div class="clear-space-five">
                    </div>
                    <div class="pad-left pad-right font-bold float-left" style="width: 85px; padding-top: 4px;">
                        Description</div>
                    <textarea id="tb_newevent_desc_pc" class="textEntry" rows="5" cols="80" style="width: 335px;
                        font-family: Arial; border: 1px solid #CCC;"></textarea>
                    <div class="clear-space-five">
                    </div>
                    <div class="float-left pad-right-big">
                        <div class="pad-left pad-right font-bold float-left" style="width: 85px; padding-top: 4px;">
                            Start Date</div>
                        <input id="tb_newevent_start_pc" type="text" class="textEntry margin-right" style="width: 85px;
                            border: 1px solid #CCC;" />
                        ...
                        <div class="pad-left pad-right font-bold float-left" style="width: 85px; padding-top: 4px;">
                            End Date</div>
                        <input id="tb_newevent_end_pc" type="text" class="textEntry margin-right" style="width: 85px;
                            border: 1px solid #CCC;" />
