...
<head runat="server">
    ...
    <style type="text/css">
        #GV_PLTHistory_ProductLeadTime_PnlPager_ProductLeadTime
        {
            width: 560px;
            height: 40px;
            overflow: auto;
        ...
        <form id="form_mydocuments" runat="server" enctype="multipart/form-data" method="post">
            ...
            <asp:UpdatePanel ID="UpdatePanel4_ProductLeadTime" runat="server">
                <ContentTemplate>
                    ...
                    <div class="pad-all">
                        <div class="float-left">
                            <span style="color: #B50000">After noon please add 1 day to lead time<br />
                    ...
                    <div align="center">
                        <table cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td class="border-right" style="width: 125px; padding: 5px 25px;">
                                        <b><u>CTL 1 (Light)</u></b>
                                    </td>
                                    <td class="border-right" style="width: 125px; padding: 5px 25px;">
                                        <b><u>CTL 2 (Heavy)</u></b>
                                    ...
                                    <td style="width: 125px; padding: 5px 25px;">
                                        <b><u>Burn Table</u></b>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="pad-all">
                        <div class="clear-margin">
                            <span class="PadLeftBig">Click inside the text box to bring up the calendar</span>
                        </div>
                        <div class="float-left">
                            ...
                            <span>Production Lead Times are sent out via email for users who have this option enabled.<br />
                                Lead Times are calculated automatically using the average of each line and there
                            lead times.<br />
                                To override the automated Lead Times, check the 'Allow Override' under each line.</span>
                        </div>
                        <div class="float-right PadRightBig">
                            <asp:Button ID="btn_update_ProductLeadTime" runat="server" CssClass="input-buttons plt-update"
                                Text="Update" OnClick="btn_update_Click" Style="width: 75px; height: 35px;" />
                        </div>
                    </div>
                    <div class="clear-space">
                    </div>
                    ...
                    <div class="float-right">
                        <small>
                            <asp:LinkButton ID="lbtn_selectAll_ProductLeadTime" runat="server" CssClass="sb-links margin-top-sml margin-right-big plt-update"
                                            ...
                                            <tr>
                                                <td width="20px" align="center">
                                                    <asp:LinkButton ID="imgbtn_del_ProductLeadTime" runat="server" ToolTip="Delete selected items"
                                                        OnClick="imgbtn_del_Click" CssClass="td-delete-light-btn" OnClientClick="return window.confirm('Are you sure you want to delete the selected files?');"
                                                ...
                                                <td style="width: 115px;">Burn Table
                                                </td>
