...
<head runat="server">
    ...
    <style type="text/css">
        .td-bg-color
        {
            color: #FFF;
            background: #ABBCD9;
            background: -moz-linear-gradient(top, rgba(171, 188, 217, 1) 0%, rgba(99, 128, 179, 1) 100%);
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(171, 188, 217, 1)), color-stop(100%,rgba(99, 128, 179, 1)));
            background: -webkit-linear-gradient(top, rgba(171, 188, 217, 1) 0%,rgba(99, 128, 179, 1) 100%);
            background: -o-linear-gradient(top, rgba(171, 188, 217, 1) 0%,rgba(99, 128, 179, 1) 100%);
            background: -ms-linear-gradient(top, rgba(171, 188, 217, 1) 0%,rgba(99, 128, 179, 1) 100%);
            background: linear-gradient(to bottom, rgba(171, 188, 217, 1) 0%,rgba(99, 128, 179, 1) 100%);
            filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#abbcd9', endColorstr='#6380b3',GradientType=0 );
        }
        ...
        ul#ScheduleMenu li, ul.ctlLineLinks li, ul.homedashlinks li, ul#ScheduleMenu li.active, ul.ctlLineLinks li.active, ul.homedashlinks li.active
        {
                                                ...
                                                <div class="content-overflow-app">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="float-left margin-left pad-top-big">
                                                                    <a class="ajaxCall_Modal sb-links float-left margin-right" href="#Contact_Modal_deliverypickups"
                                                    ...
                                                    <div class="clear-margin">
                                                        <div class="float-left margin-left" style="min-width: 450px;">
                                                            <div id="searchwrapper" style="width: 95%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class='<%#Eval("Type") %>'>
                                                                                            <div class='<%#Eval("NewSlot") %>'>
                                                                                                <div class="float-left">
                                                                                                    <asp:LinkButton ID="lbnewapp" runat="server" CssClass="sb-links deliverypickup-update"
                                                                                                ...
                                                                                                <div class="clear">
                                                                                                    ...
                                                                                                    <div class="float-right" style="margin-top: 2px;">
                                                                                                        ...
                                                                                                        <asp:LinkButton ID="lbComplete" runat="server" CssClass="margin-right-sml td-update-btn deliverypickup-update"
                                                                                                            ...
                                                                                                            OnClientClick="var c = confirm(&apos;Are you sure you want to mark this event as complete? You will not be able to edit this after complete.&apos;);if(c == false){setTimeout(function(){RemoveUpdateModal();},500);return false;}else{return true;}"></asp:LinkButton>
                                                                                                        ...
                                                                                                        <asp:LinkButton ID="lbdelete" runat="server" CssClass="margin-right-sml td-delete-btn deliverypickup-update"
                                                                                                            ...
                                                                                                            OnClientClick="var c = confirm(&apos;Are you sure you want to delete this event?&apos;);if(c == false){setTimeout(function(){RemoveUpdateModal();},500); return false;}else{return true;}"></asp:LinkButton>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </asp:Panel>
                                                                                        </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <dl class="myItemStyleDP float-left" style="width: 350px;">
                                                                                                    <dt>Truck Line</dt>
                                                                                                    <dd>
                                                                                                        <asp:TextBox runat="server" ID="tb_company" CssClass="TextBoxEdit" Text='<%#Eval("Company") %>'
                                                                                                            AutoCompleteType="Search" AutoPostBack="True"></asp:TextBox>
                                                                                                    </dd>
                                                                                                    <dt>Truck Number</dt>
                                                                                                    <dd>
                                                                                                        <asp:TextBox runat="server" ID="tb_trucknum" CssClass="TextBoxEdit" Text='<%#Eval("TruckNum")%>'
                                                                                                            AutoCompleteType="Search" AutoPostBack="True"></asp:TextBox>
                                                                                                    </dd>
                                                                                                </dl>
                                                                                                <dl class="myItemStyleDP float-left" style="width: 350px;">
                                                                                                    <dt>Mill/Processor</dt>
                                                                                                    <dd>
                                                                                                        <asp:TextBox runat="server" ID="tb_from" CssClass="TextBoxEdit" Text='<%#Eval("DeliveryFrom") %>'
                                                                                                            AutoCompleteType="Search" AutoPostBack="True"></asp:TextBox></dd>
                                                                                                    <dt>Email Address</dt>
                                                                                                    <dd>
                                                                                                        <asp:TextBox runat="server" ID="tb_email" CssClass="TextBoxEdit" Text='<%#Eval("Email") %>'
                                                                                                            AutoCompleteType="Search" AutoPostBack="True"></asp:TextBox></dd>
                                                                                                </dl>
                                                                                                <dl class="myItemStyleDP float-left" style="width: 300px;">
                                                                                                    <dt>Confirmation</dt>
                                                                                                    ...
                                                                                                    <dt>Phone Number</dt>
                                                                                                    <dd>
                                                                                                        <asp:TextBox runat="server" ID="tb_phonenumber" CssClass="TextBoxEdit" Text='<%#Eval("PhoneNumber") %>'
                                                                                                ...
                                                                                                <dl class="myItemStyleDP float-left" style="width: 300px;">
                                                                                                    <dt>Number of Items</dt>
                                                                                                    <dd>
                                                                                                        <asp:TextBox runat="server" ID="tb_items" CssClass="TextBoxEdit" Text='<%#Eval("Items") %>'
                                                                                                ...
                                                                                                <div class="clear">
                                                                                                    <div class="float-left" style="width: 350px;">
                                                                                                        <span style="color: #707070; font-weight: bold;" class="PadRightBig">Comments</span><asp:TextBox
                                                                                                            runat="server" ID="tb_comment" CssClass="TextBoxEdit" Text='<%#Eval("Comment") %>'
                                                                                ...
                                                                                <div id="container_Sch">
                                                                                    <asp:Panel ID="Step1_deliverypickups" runat="server" CssClass="inline-block" Style="width: 260px;">
                                                                                        <div class="myItemStyle" style="height: 260px;">
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td class="contactFormInput">
                                                                                                                ...
                                                                                                                <div class="float-right PadRightBig">
                                                                                                                    Items<br />
                                                                                                                    <input id="schedule_items_deliverypickups" type="text" class="TextBoxControls" style="width: 30px;"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="contactFormInput">Truck Line<br />
                                                                                                                <input id="schedule_name_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                                                    style="width: 225px;" />
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="contactFormInput">Mill/Processor Name:<br />
                                                                                                                <input id="schedule_from_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                                                    style="width: 225px;" />
                                                                                                                <span class="float-right" style="color: Red; padding-left: 5px;"><small>*</small></span>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td class="contactFormInput">E-mail<br />
                                                                                                                <input id="schedule_email_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                            ...
                                                                                            <div class="float-right contactFormInput" style="width: 250px; padding: 10px 0;">
                                                                                                Phone Number<br />
                                                                                                <input id="schedule_phone1_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                                    style="width: 35px;" maxlength="3" />
                                                                                                -
                                                                                            <input id="schedule_phone2_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                                style="width: 35px;" maxlength="3" />
                                                                                                -
                                                                                            <input id="schedule_phone3_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                                style="width: 45px;" maxlength="4" />
                                                                                                <div class="clear-space">
                                                                                                </div>
                                                                                                Truck Number<br />
                                                                                                <input id="schedule_trucknum_deliverypickups" runat="server" type="text" class="TextBoxControls"
                                                                                    ...
                                                                                    <asp:Panel ID="Step2_deliverypickups" runat="server" CssClass="inline-block" Style="width: 260px;">
                                                                                        ...
                                                                                        <div class="clear pad-all">
                                                                                            ...
                                                                                            <br />
                                                                                            <asp:LinkButton ID="lb_clearDate_deliverypickups" runat="server" CssClass="sb-links deliverypickup-update-modal"
                                                                                        ...
                                                                                        <div class="float-right" style="width: 315px;">
                                                                                            ...
                                                                                            <div class="clear-margin">
                                                                                                ...
                                                                                                <asp:Button ID="btn_finish_deliverypickups" runat="server" Text="" CssClass="input-buttons-create deliverypickup-update-modal"
