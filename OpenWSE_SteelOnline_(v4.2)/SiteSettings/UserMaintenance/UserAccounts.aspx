<%@ Page Title="User Accounts" Async="true" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="UserAccounts.aspx.cs" Inherits="SiteSettings_UserAccounts" %>
        ...
        <div id="useraccounts">
            <asp:Panel ID="pnl_admin_tools" runat="server" CssClass="float-left">
                ...
                <div id="customizeBtns" class="float-left">
                    <a id="btn_customizeua" href="#iframecontent" class="sb-links margin-right" onclick="openWSE.LoadIFrameContent('SiteSettings/UserMaintenance/AcctSettings.aspx?toolview=true&u=NewUserDefaults', this);return false;">
                    ...
                    <a id="btn_appsusers" href="#iframecontent" class="sb-links margin-right margin-left"
                        onclick="openWSE.LoadIFrameContent('SiteSettings/iframes/UsersAndApps.aspx', this);return false;">
