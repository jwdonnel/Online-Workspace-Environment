<%@ Page Title="Group Organizer" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="GroupOrg.aspx.cs" Inherits="SiteSettings_GroupOrg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="maincontent-padding pad-top-big margin-top">
        ...
        <div id="NewEdit-Group-element" class="Modal-element">
            <div class="Modal-overlay">
                <div class="Modal-element-align">
                    <div class="Modal-element-modal" style="width: 570px;">
                        ...
                        <div class="ModalPadContent" style="height: 265px;">
                            <div style="width: 220px; height: 180px;" class="inline-block float-left">
        ...
        <div id="GroupNetwork-element" class="Modal-element">
            <div class="Modal-overlay">
                <div class="Modal-element-align">
                    <div class="Modal-element-modal" style="width: 575px;">
                        <div class="ModalHeader">
                            <div>
                                <div class="app-head-button-holder-admin">
