...
public partial class SiteSettings_AppDownloadBtn : System.Web.UI.Page {
            ...
            if (!ServerSettings.AdminPagesCheck("appmanager.aspx", userId.Name)) {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["id"])) {
                    ...
                    if (Roles.IsUserInRole(userId.Name, ServerSettings.AdminUserName)) {
                        ...
                        lb_downloadApp.Text = "<img alt='download' src='../../App_Themes/" + member.SiteTheme + "/Icons/download.png' class='float-left pad-right-sml' />Download All Apps";
                    }
                    else {
                        lb_downloadApp.Enabled = false;
                        lb_downloadApp.Visible = false;
    ...
    protected void lb_downloadApp_Click(object sender, EventArgs e) {
        ...
        if (hf_appID.Value == "DownloadAll") {
            ...
            downloadFilename = ServerSettings.SiteName.Replace(" ", "_") + "_Apps";
        }
        else {
        ...
        Response.Flush();
        Response.End();
        //Response.Redirect("~/SiteSettings/iframes/AppDownloadBtn.aspx", true);
    }
