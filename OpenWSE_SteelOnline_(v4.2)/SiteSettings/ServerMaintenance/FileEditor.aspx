<%@ Page Title="File Editor" Async="true" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="FileEditor.aspx.cs" Inherits="SiteSettings_FileEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="maincontent-padding pad-top-big margin-top">
                    ...
                    <asp:Panel ID="pnl1" runat="server">
                        <div class="float-left" style="width: 475px;">
                            <div id="searchwrapper" style="width: 444px;">
                                <asp:Panel ID="Panel1_FileEditor" runat="server" DefaultButton="imgbtn_search">
                        ...
                        <div class="float-right">
                            <div class="float-right pad-right-sml">
                                <small><b class="pad-right-sml">Note:</b>The FileEditor only loads files with extensions:
                                .js and .css</small>
                            </div>
                            <div class="clear-space">
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="100px" align="center" class='border-right'>
                                                        <asp:LinkButton ID="LinkButton3" CssClass='<%#Eval("DownloadClass") %>' runat="server"
                                                            ...
                                                            PostBackUrl="FileEditor.aspx"></asp:LinkButton>
                                                        <a href='FileEditor.aspx?edit=true&file=<%#Eval("Path") %>' class='<%#Eval("EditClass") %>'
                                                            title="Edit"></a><a href='FileEditor.aspx?edit=false&file=<%#Eval("Path") %>' class="img-view pad-all-sml margin-left-sml RandomActionBtns"
                                                                title="View"></a>
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <asp:Panel ID="pnl2" runat="server" Enabled="false" Visible="false">
            ...
            <asp:HyperLink ID="lbtn_close" NavigateUrl="FileEditor.aspx" CssClass="sb-links margin-right float-right"
        ...
        <script type="text/javascript" src='<%=ResolveUrl("~/Scripts/SiteTools/fileEditor.js")%>'> </script>
