<%@ Page Title="Site Settings" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="SiteSettings.aspx.cs" Inherits="SiteSettings_SiteSettings" %>
                                ...
                                <asp:Panel ID="pnl_mailsettings" runat="server">
                                    ...
                                    <div class="clear-space">
                                        ...
                                        <a id="btn_customizeSMTP" runat="server" clientidmode="Static" href="#iframecontent"
                                            class="sb-links margin-right float-left" onclick="openWSE.LoadIFrameContent('SiteSettings/iframes/EmailSettings.aspx', this);return false;"
                        ...
                        <asp:Panel ID="pnl_admincontrolsonly" CssClass="pnl-section" runat="server" Enabled="false" Visible="false">
                            ...
                            <div class="pad-all">
                                ...
                                <table cellpadding="10" cellspacing="10">
                                    <tr>
                                        <td class="td-settings-title">
                                            <span class="pad-right font-bold">Lock File Editor</span>
                                        </td>
                                        <td class="td-settings-ctrl">
                                            <div class="field switch inline-block">
                                                <asp:RadioButton ID="rb_LockFileEditor_on" runat="server" Text="Yes" CssClass="RandomActionBtns cb-enable"
                                                    OnCheckedChanged="rb_LockFileEditor_on_CheckedChanged" AutoPostBack="True" />
                                                <asp:RadioButton ID="rb_LockFileEditor_off" runat="server" Text="No" CssClass="RandomActionBtns cb-disable"
                                                    OnCheckedChanged="rb_LockFileEditor_off_CheckedChanged" AutoPostBack="True" />
                                            </div>
                                        </td>
                                        <td class="td-settings-desc">
                                            <small>Lock the File Editor so no other user can view the source
                                ...
                                <asp:Panel ID="pnl_NoLoginMainPage" runat="server" Enabled="false" Visible="false">
                                    ...
                                    <a href="#iframecontent" class="sb-links margin-right float-left" onclick="openWSE.LoadIFrameContent('SiteSettings/UserMaintenance/AcctSettings.aspx?u=demouser&toolview=true', this);return false;"
                                    ...
                                    <div id="rb_usersignup_holder" runat="server">
                                        ...
                                        <asp:Panel ID="pnl_UserSignUp" runat="server">
                                            ...
                                            <a id="btn_customizeua" href="#iframecontent" class="sb-links margin-right float-left"
                                                onclick="openWSE.LoadIFrameContent('SiteSettings/UserMaintenance/AcctSettings.aspx?toolview=true&u=NewUserDefaults&NoRegistration=true', this);return false;"
