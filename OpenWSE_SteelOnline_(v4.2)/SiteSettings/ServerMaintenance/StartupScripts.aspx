<%@ Page Title="Startup Scripts" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="StartupScripts.aspx.cs" Inherits="SiteSettings_StartupScripts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="maincontent-padding pad-top-big margin-top">
        ...
        <div class="pad-bottom">
            ...
            of the scripts. To edit a script, go to the File Editor page.</small>
            </div>
            <div class="clear">
            </div>
