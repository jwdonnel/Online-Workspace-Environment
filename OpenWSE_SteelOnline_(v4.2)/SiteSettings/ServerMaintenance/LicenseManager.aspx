<%@ Page Title="License Manager" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="LicenseManager.aspx.cs" Inherits="SiteSettings_LicenseManager" %>
                ...
                <asp:Panel ID="pnl_purchaseVersion" runat="server" Enabled="false" Visible="false">
                    <div class="pad-all">
                        ...
                        <div class="float-left pad-right-big margin-right-big pad-top-big margin-top-big">
                            <iframe src="<%=ServerSettings.LicenseSite %>iframes/PayPal_BuyNow.aspx" class="float-left margin-left" style="width: 205px; height: 90px; border: none; overflow: hidden;"></iframe>
                        </div>
                        <div class="float-left pad-left-big pad-top-big margin-top-big">
                            <img alt="soLogo" src="../../Standard_Images/About Logos/openwse.png" />
                        </div>
