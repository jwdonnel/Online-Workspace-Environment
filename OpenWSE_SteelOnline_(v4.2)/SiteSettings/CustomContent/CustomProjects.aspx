<%@ Page Title="Custom Projects" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CustomProjects.aspx.cs" Inherits="SiteSettings_CustomProjects" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="maincontent-padding pad-top-big margin-top">
        ...
        <a href="#iframecontent" id="createcustompage" runat="server" onclick="openWSE.LoadIFrameContent('SiteSettings/iframes/ProjectExplorer.aspx', this);return false;">Create Custom Project</a>
