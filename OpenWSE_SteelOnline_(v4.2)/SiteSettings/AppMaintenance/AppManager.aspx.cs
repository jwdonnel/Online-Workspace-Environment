...
public partial class SiteSettings_AppManager : Page {
    ...
    private void Appedit() {
        ...
        if (string.IsNullOrEmpty(about))
            tb_about_edit.Text = ServerSettings.SiteName + " | " + DateTime.Now.Year + " | " + "John Donnelly";
        else
    ...
    protected void lb_editsource_Click(object sender, EventArgs e) {
        ...
        if (!string.IsNullOrEmpty(tb_filename_edit.Text)) {
            ...
            if (File.Exists(ServerSettings.GetServerMapLocation + "Apps\\" + tb_filename_edit.Text)) {
                ...
                if ((!_ss.LockFileEditor) || (_username.ToLower() == ServerSettings.AdminUserName.ToLower())) {
                    ...
                    if (dir != "Apps") {
                        ...
                        foreach (string fn in filesInDir) {
                            ...
                            if ((fi_indir.Extension.ToLower() == ".cs") || (fi_indir.Extension.ToLower() == ".js")) {
                                ...
                                extLinks.Append("<a href='" + ResolveUrl("~/SiteSettings/ServerMaintenance/FileEditor.aspx?edit=" + editable + "&file=" + parentFolder2) + "' ");
