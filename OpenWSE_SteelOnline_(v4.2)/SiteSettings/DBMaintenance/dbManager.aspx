<%@ Page Title="Database Manager" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="dbManager.aspx.cs" Inherits="SiteSettings_DbManager" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:LinkButton ID="lbtn_downloaddb" runat="server" CssClass="sb-links" OnClick="lbtn_downloaddb_Click"
                                PostBackUrl="~/SiteSettings/DBMaintenance/dbManager.aspx" Style="margin-left: 50px;">Download</asp:LinkButton>
                        </ContentTemplate>
                        <Triggers>
                                            ...
                                            <tr>
                                                ...
                                                <td width="100px" align="center" style="border-right: 1px solid #CCC;">
                                                    ...
                                                    <asp:LinkButton ID="lb_downloadthis" runat="server" CommandArgument='<%# XPath("Filename") %>'
                                                        CommandName="Download" CssClass="td-download-btn margin-right-sml" PostBackUrl="~/SiteSettings/DBMaintenance/dbManager.aspx"
                                ...
                                <div class="clear-margin">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:Panel ID="pnl_tablerestore" runat="server" CssClass="modal-inner-scroll" Style="height: auto;">
