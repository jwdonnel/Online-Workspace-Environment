<%@ Page Title="Database Viewer" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="dbViewer.aspx.cs" Inherits="SiteSettings_dbViewer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="maincontent-padding pad-top-big margin-top">
        <small><b class="pad-right-sml">Note:</b>Only customized tables are shown in the drop down
        menu. All ASP.Net tables are restricted and cannot be viewed by any user.</small>
        ...
        <div class="float-left">
            ...
            <a href="#" id="a_turn_onoff_refresh" class="sb-links margin-left dbviewer-update-img">Turn off</a>
        </div>
        <div class="clear-space">
        </div>
        <div class="float-left pad-right-big">
            <b class="float-left pad-right pad-top">Table Name:</b>
            ...
            <div class="float-left">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:LinkButton ID="lbtn_savetable" runat="server" CssClass="sb-links margin-left float-left dbviewer-update-img"
                            OnClick="lbtn_savetable_Click"></asp:LinkButton>
                        <asp:Label ID="lbl_tablesaved_msg" runat="server" Text="Table has been backed up. Refresh the page to see the file under Database Maintenance."
