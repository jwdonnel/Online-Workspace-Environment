        ...
        try {
            ...
            if (File.Exists(filePath)) {
                ...
                if (File.Exists(webConfigPath)) {
                    ...
                    ServerSettings.StartServerApplication();
                    Response.Redirect("~/SiteSettings/ServerMaintenance/SiteSettings.aspx");
                }
            }
        }
        catch { }
            ...
            try {
                ...
                if (File.Exists(filePath)) {
                    ...
                    if (File.Exists(webConfigPath)) {
                        ...
                        ServerSettings.StartServerApplication();
                        HttpContext.Current.Response.Redirect("~/SiteSettings/ServerMaintenance/SiteSettings.aspx");
                    }
                }
            }
            catch { }
