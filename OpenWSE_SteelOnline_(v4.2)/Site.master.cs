        ...
        if (pageLoadInit.CanLoadPage) {
            if (pageLoadInit.CheckIfLicenseIsValid()) {
                ...
                if (!IsPostBack && CheckLicense.TrialActivated && CheckLicense.LicenseValid) {
                    ...
                    trialScript += "$('.purchase-icon').remove();$('.footer-padding').append(\"<a class='purchase-icon' title='Purchase the full version' href='" + ResolveUrl("~/SiteSettings/ServerMaintenance/LicenseManager.aspx?purchase=true") + "'></a>\");";
