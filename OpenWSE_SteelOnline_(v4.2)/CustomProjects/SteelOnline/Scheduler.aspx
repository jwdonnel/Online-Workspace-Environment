...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" runat="server" href="~/App_Themes/Standard/site_desktop.css" />
    <link rel="stylesheet" type="text/css" runat="server" href="~/App_Themes/Standard/jqueryUI.css" />
    <style type="text/css">
        .loading-frame
        {
            position: absolute;
...
<body>
    ...
    <asp:UpdatePanel ID="updatepnl_newApp_deliverypickups" runat="server">
        <ContentTemplate>
                            ...
                            <td class="contactFormInput">
                                ...
                                <div class="float-right PadRightBig">
                                    ...
                                    <input id="schedule_items_deliverypickups" type="text" class="TextBoxControls" style="width: 30px;
                                        margin-right: 17px" maxlength="2" runat="server" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="float-left" style="padding: 10px 0; width: 300px">
                Phone Number<br />
                ...
                <textarea id="schedule_comment_deliverypickups" runat="server" class="TextBoxComment"
                    rows="2" style="width: 210px; height: 65px; font-family: Arial; padding: 3px;
            ...
            <div class="float-left">
                <div class="clear" style="padding: 10px 0">
                    <h3>
                        <strong class="font-color-black">Schedule</strong> Date</h3>
                    ...
                    <asp:LinkButton ID="lb_clearDate_deliverypickups" runat="server" CssClass="sb-links margin-left deliverypickup-update"
                ...
                <div class="clear" style="padding: 15px 0">
                    ...
                    <div class="clear-margin pad-all">
                        ...
                        (Hours: 6:30 am - 10:00 pm, Monday - Friday)</div>
            ...
            <asp:Panel ID="Step3_deliverypickups" runat="server" CssClass="pad-top" Style="padding-left: 20px;
                display: none">
