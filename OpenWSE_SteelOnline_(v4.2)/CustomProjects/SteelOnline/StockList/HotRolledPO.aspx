<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HotRolledPO.aspx.cs" Inherits="Integrated_Pages_StockList_HotRolledPO" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Hot Rolled P&O</title>
    ...
    <link id="Link4" rel="stylesheet" type="text/css" runat="server" href="~/App_Themes/Standard/site_desktop.css" />
