...
public partial class Integrated_Pages_StockList_HotRolled : System.Web.UI.Page {
    private SteelInventory inventory = new SteelInventory();

    protected void Page_Load(object sender, EventArgs e) {
        #region Build Sheets Table
        inventory.BuildTable("Hot Rolled Sheet", hfSortBy.Value);
        ...
        inventory.BuildTable("Hot Rolled Coil", hfSortBy.Value);
