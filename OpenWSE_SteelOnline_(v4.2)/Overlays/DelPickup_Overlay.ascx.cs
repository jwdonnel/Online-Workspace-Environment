...
public partial class Overlays_DelPickup_Overlay : System.Web.UI.UserControl {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        _overlayInit = new OverlayInitializer(userId.Name, "Overlays/DelPickup_Overlay.ascx");
    ...
    private string BuildJS {
        get {
            ...
            str.Append("$.ajax({");
            str.Append("url: '" + ResolveUrl("~/Apps/DeliveryPickups/GetNextPickup.asmx/GetNext") + "',");
