...
public partial class Overlays_Groups_Overlay : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        _overlayInit = new OverlayInitializer(userId.Name, "Overlays/Groups_Overlay.ascx");
    ...
    private void LoadUserGroups_NoLogin()
    {
        ...
        str.Append("<div class='float-left' style='padding-top: 9px;'>" + ServerSettings.SiteName + " Guest</div>");
        str.Append("</div>");
        groups_pnl_entries.Controls.Add(new LiteralControl(str.ToString()));
    }
}