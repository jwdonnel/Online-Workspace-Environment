...
<body>
    <form id="form1" runat="server">
        ...
        <table id="table-container" cellpadding="0" cellspacing="0">
            <tr>
                <td class="left-panel">
                    <div id="pnl_purchaseFullVer" runat="server" class="panel-link" onclick="window.location.href='SiteSettings/ServerMaintenance/LicenseManager.aspx?purchase=true';" visible="false">
