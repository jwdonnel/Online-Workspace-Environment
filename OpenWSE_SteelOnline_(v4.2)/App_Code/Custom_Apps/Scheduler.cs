...
public class Scheduler {
    ...
    public int getTotalDelPu(string date, string type) {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("SELECT * FROM Scheduler WHERE ScheduleDate like '" + date + "%' AND ScheduleType='" + type + "'");
        return dbSelect.Count;
    }

    public int getTotalComplete() {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("SELECT * FROM Scheduler WHERE Complete='true'");
        return dbSelect.Count;
    }

    public int getTotalComplete(string date) {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("SELECT * FROM Scheduler WHERE ScheduleDate like '" + date + "%' AND Complete='true'");
        return dbSelect.Count;
    }
