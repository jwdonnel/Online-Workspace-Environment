...
public class DBImporter
{
    ...
    public void SavedConnectionsSerialize(List<SavedConnections> list)
    {
        try
        {
            ...
            d.SerializeFile(list, loc_SavedConnections);
            d.EncryptFile(loc_SavedConnections, encryptloc_SavedConnections, ServerBackup.EncryptPassword);
        }
        catch (Exception e)
        {
            applog.AddError(e);
    ...
    public void SavedConnectionsDeserialize()
    {
        try
        {
            ...
            {
                var d = new DataEncryption();
                MemoryStream a = d.DecryptFile(encryptloc_SavedConnections, ServerBackup.EncryptPassword);
    ...
    public void BinarySerialize(List<DBImporter_Coll> list)
    {
        ...
        {
            var d = new DataEncryption();
            d.SerializeFile(list, loc);
            d.EncryptFile(loc, encryptloc, ServerBackup.EncryptPassword);
        }
        catch (Exception e)
        {
            applog.AddError(e);
