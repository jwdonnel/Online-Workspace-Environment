...
public class UserCalendar
{
    ...
    {
        dataTable = dbCall.CallSelect("aspnet_UserCalendar", "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username.ToLower()) }, "StartDate DESC");
    }

    public void GetEvent(string id)
    {
        dataTable = dbCall.CallSelect("aspnet_UserCalendar", "", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }
    ...
    {
        dbCall.CallDelete("aspnet_UserCalendar", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }

    public void DeleteEvents(string userName) {
        dbCall.CallDelete("aspnet_UserCalendar", new List<DatabaseQuery>() { new DatabaseQuery("UserName", userName) });
    }
