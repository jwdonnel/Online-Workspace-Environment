    ...
    public void Create() {
        ...
        try {
            ...
            if (File.Exists(ServerSettings.GetServerMapLocation + CreateSitemap.SiteMapFileName)) {
                ...
                lines.Add("Allow: /SiteSettings/CustomContent/");
                lines.Add("Allow: /SiteSettings/DBMaintenance/");
                lines.Add("Allow: /SiteSettings/ServerMaintenance/");
                lines.Add("Allow: /SiteSettings/UserMaintenance/");
                lines.Add("Allow: /SiteSettings/AppMaintenance/");
                lines.Add("");
