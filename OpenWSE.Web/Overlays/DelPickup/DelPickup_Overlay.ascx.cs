...
public partial class Overlays_DelPickup_Overlay : System.Web.UI.UserControl {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        _overlayInit = new OverlayInitializer(userId.Name, "Overlays/DelPickup/DelPickup_Overlay.ascx");
    ...
    private string BuildJS {
        get {
            ...
            str.Append("    openWSE.AjaxCall('" + ResolveUrl("~/Apps/DeliveryPickups/GetNextPickup.asmx/GetNext") + "', '{ }', null, function (data) {");
            str.Append("        var response = data.d;");
            str.Append("        if (response != '') {");
            str.Append("            $('#delpickup_pnl_entries').html(response);");
            str.Append("        }");
            str.Append("    });");
            str.Append("});");
