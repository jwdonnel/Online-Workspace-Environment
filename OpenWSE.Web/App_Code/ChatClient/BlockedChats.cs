...
public class BlockedChats
{
    ...
    {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("aspnet_BlockedChats", "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _userName), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
    ...
    public void DeleteEntryByUserName(string userName) {
        dbCall.CallDelete("aspnet_BlockedChats", new List<DatabaseQuery>() { new DatabaseQuery("UserName", userName), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
    }

    public void DeleteEntryByID(string id) {
        dbCall.CallDelete("aspnet_BlockedChats", new List<DatabaseQuery>() { new DatabaseQuery("ID", id), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
    }

    public void DeleteEntryByChatUser(string chatUser) {
        dbCall.CallDelete("aspnet_BlockedChats", new List<DatabaseQuery>() { new DatabaseQuery("ChatUser", chatUser), new DatabaseQuery("UserName", _userName), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
    }
    ...
    {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("aspnet_BlockedChats", "ID", new List<DatabaseQuery>() { new DatabaseQuery("UserName", user), new DatabaseQuery("ChatUser", _userName), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
