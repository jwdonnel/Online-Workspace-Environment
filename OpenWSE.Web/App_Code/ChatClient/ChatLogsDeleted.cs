...
public class ChatLogsDeleted
{
    ...
    {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect("aspnet_ChatLogsDeleted", "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _username.ToLower()), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) }, "LogDate ASC");
