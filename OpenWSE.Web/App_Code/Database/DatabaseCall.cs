...
public class DatabaseCall {
    ...
    private const string ConnectionNotOpenError = "{0} requires an open and available Connection. The connection's current state is {1}.";
    ...
    public const string ApplicationIdString = "ApplicationId";
    ...
    private void InitiateConnection() {
        if (!string.IsNullOrEmpty(_dataProvider) && !string.IsNullOrEmpty(_connString)) {
            _connection = DatabaseProviders.CreateConnectionObject(_dataProvider);
            if (_connection != null) {
    ...
    private void AddSqlParameters(List<DatabaseQuery> parms, string type) {
        for (int i = 0; i < parms.Count; i++) {
            ...
            int tempInt = 0;
            if (parm.DbType == DbType.Boolean) {
                parm.Value = HelperMethods.ConvertBitToBoolean(val);
                parm.Value = parm.Value.ToString()[0].ToString().ToUpper() + parm.Value.ToString().Substring(1);
            }
            else if (int.TryParse(val, out tempInt)) {
    ...
    private bool CheckConnectionFirst() {
        try {
            if (_connection != null && (_connection.State == ConnectionState.Open || _connection.State == ConnectionState.Executing || _connection.State == ConnectionState.Broken || _connection.State == ConnectionState.Connecting || _connection.State == ConnectionState.Fetching)) {
                _connection.Close();
                _connection.Dispose();
    ...
    private void AddConnectionStateError(string method) {
        if (_connection != null) {
            AppLog.AddError(string.Format(ConnectionNotOpenError, method, _connection.State));
        }
    }
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallInsert");
                }
            }
        }
        catch (Exception e) {
            ...
            if (CheckConnectionFirst()) {
                ...
                using (_command) {
                    ...
                    if (_connection.State == ConnectionState.Open) {
                        ...
                        AddConnectionStateError("CallSelectSingle");
                    }
                }
            }
        }
            ...
            if (CheckConnectionFirst()) {
                using (_command) {
                    ...
                    if (_connection.State == ConnectionState.Open) {
                        ...
                        AddConnectionStateError("CallSelect");
                    }
                }
            }
        }
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallUpdate");
                }
            }
        }
        catch (Exception e) {
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallDelete");
                }
            }
        }
        catch (Exception e) {
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallDropTable");
                }
            }
        }
        catch (Exception e) {
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallCreateTable");
                }
            }
        }
        catch (Exception e) {
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallAlterTable");
                }
            }
        }
        catch (Exception e) {
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallGetSchema");
                }
            }
        }
        catch (Exception e) {
    ...
    /// <param name="query"></param>
    /// <returns></returns>
    public DataTable CallGetDataTable(string table, int rowsToSelect = -1) {
        DataTable dataTable = new DataTable();
        try {
            if (CheckConnectionFirst()) {
                string cmdText = string.Format("SELECT * FROM {0}", table);
                if (rowsToSelect > 0) {
                    cmdText = string.Format("SELECT TOP({0}) * FROM {1}", rowsToSelect.ToString(), table);
                }
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallGetDataTable");
                }
            }
        }
        catch (Exception e) {
        ...
        try {
            if (CheckConnectionFirst()) {
                ...
                if (_connection.State == ConnectionState.Open) {
                    ...
                    AddConnectionStateError("CallGetDataTableBySelectStatement");
                }
            }
        }
        catch (Exception e) {
