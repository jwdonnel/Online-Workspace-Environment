...
namespace OpenWSE.API.TwitterLogin {
    public class TwitterConnect {
        ...
        private string ApiVersion {
            get {
                string version = WebConfigurationManager.AppSettings["TwitterApiVersion"];
        ...
        private string FetchTwitterProfile(string screenName) {
            ...
            empty = "https://api.twitter.com/" + ApiVersion + "/users/show.json";
            if (screenName == null) {
        ...
        public void Tweet(string content) {
            ...
            if (twitterAuth.TokenSecret.Length > 0) {
                empty = "https://api.twitter.com/" + ApiVersion + "/statuses/update.json";
