            ...
            if (Request != null) {
                try {
                    ...
                    if (TwitterConnect.IsAuthorized) {
                        ...
                        TwitterUser twitterUser = ServerSettings.CreateJavaScriptSerializer().Deserialize<TwitterUser>(json);
                        ...
                        if (twitterUser != null) {
                            ...
                            if (mUser != null) {
                                ...
                                if (_member.IsSocialAccount) {
                                    ...
                                    if (string.IsNullOrEmpty(_member.AccountImage) && !string.IsNullOrEmpty(twitterUser.profile_image_url)) {
                                        _member.UpdateAcctImage(twitterUser.profile_image_url);
                                    }
                                }
                            }
                            else {
