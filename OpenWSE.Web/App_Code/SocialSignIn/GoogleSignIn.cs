        ...
        public static void FinishSignIn() {
            ...
            if (Request != null) {
                try {
                    ...
                    GoogleProfile profile = ServerSettings.CreateJavaScriptSerializer().Deserialize<GoogleProfile>(json);
                        ...
                        foreach (Email email in profile.Emails) {
                            ...
                            if (mUser != null) {
                                ...
                                if (_member.IsSocialAccount) {
                                    ...
                                    if (string.IsNullOrEmpty(_member.AccountImage) && profile.Image != null && !string.IsNullOrEmpty(profile.Image.Url)) {
                                        _member.UpdateAcctImage(profile.Image.Url);
                                    }
                                }
                            }
                            else {
