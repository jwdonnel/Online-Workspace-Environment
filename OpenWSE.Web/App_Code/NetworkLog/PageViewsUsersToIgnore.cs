...
public class PageViewsUsersToIgnore {
    ...
    public void DeleteItemsByUsername(string username) {
        dbCall.CallDelete(TableName, new List<DatabaseQuery>() { new DatabaseQuery("Username", username.ToLower()), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
    }
