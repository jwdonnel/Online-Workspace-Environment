...
public class IPWatch {
    ...
    public void deleteIP(string ip) {
        dbCall.CallDelete("aspnet_IPWatchList", new List<DatabaseQuery>() { new DatabaseQuery("IPAddress", ip), new DatabaseQuery(DatabaseCall.ApplicationIdString, ServerSettings.ApplicationID) });
    }
}