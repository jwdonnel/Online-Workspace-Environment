...
<body>
    ...
    For more information about Steel Manufacturing and Warehouse Company's products
        ...
        <ContentTemplate>
            ...
            <div class="float-left pad-right-big margin-right-big">
                ...
                <asp:TextBox ID="tb_Comment" runat="server" TextMode="MultiLine" Height="70px" Font-Names="Arial"
                    Width="215px" BorderColor="#D9D9D9" BorderWidth="1px" Style="padding: 10px" />
            </div>
            <div class="float-left">
                ...
                <div class="clear-margin">
                    <asp:Button ID="btn_Send" runat="server" CssClass="input-buttons-create contact-update margin-right"
                        OnClick="btn_Send_Clicked" Text="Send" Width="125px" />
                    <asp:Button ID="btn_Reset" runat="server" CssClass="input-buttons-create contact-update"
                        OnClick="btn_Reset_Clicked" Text="Reset" Width="125px" />
                </div>
            </div>
            <div class="clear-margin">
