...
<head runat="server">
    ...
    <link id="Link1" rel="stylesheet" type="text/css" runat="server" href="~/App_Themes/Standard/StyleSheets/Main/main.css" />
    <link id="Link2" rel="stylesheet" type="text/css" runat="server" href="~/App_Themes/Standard/StyleSheets/Main/sitemaster.css" />
    <link id="Link3" rel="stylesheet" type="text/css" runat="server" href="~/App_Themes/Standard/StyleSheets/Main/jqueryUI.css" />
    <style type="text/css">
        body
        {
        ...
        <asp:UpdatePanel ID="updatepnl_newApp_deliverypickups" runat="server">
            <ContentTemplate>
                ...
                <script type="text/javascript">
                    ...
                    function deleteEntry(i) {
                        ...
                        if (r == true) {
                            ...
                            openWSE.CallDoPostBack("hf_DeleteRequest", "");
                        }
                    }
                    ...
                    function ClearOutCurrent() {
                        ...
                        openWSE.CallDoPostBack("hf_ResetRequest", "");
                    }
                    ...
                    function SendRequest() {
                        ...
                        openWSE.CallDoPostBack("hf_SendRequest", "");
                    }
                ...
                <div class="float-left">
                    ...
                    To send multiple inquires, select 'Add Inquire'.<br />
                ...
                <asp:Panel ID="pnl_entry" runat="server">
                    <div class="float-left" style="margin-right: 30px">
                        <div class="float-left" style="width: 325px">
                            ...
                            <a href="#custom" id="a_customsize" onclick="UseCustomSize();return false;" style="text-decoration: underline">Use Custom Size</a> <a href="#standard" id="a_standard"
                                onclick="UseStandardSize();return false;" style="text-decoration: underline; display: none">Use Standard Size</a>
                    ...
                    <div class="float-left">
                        ...
                        <div class="float-left" style="width: 250px">
                            ...
                            <asp:TextBox ID="tb_PNAreaCode" runat="server" CssClass="textEntryPhoneNumber margin-right"
                                MaxLength="3" Width="55px" /><span>-</span><asp:TextBox ID="tb_PN1" runat="server"
                                    CssClass="textEntryPhoneNumber margin-right margin-left" MaxLength="3" Width="55px" /><span>-</span><asp:TextBox
                            ...
                            <asp:TextBox ID="tb_Comment" runat="server" TextMode="MultiLine" Height="70px" Font-Names="Arial"
                                Width="215px" BorderColor="#D9D9D9" BorderWidth="1px" MaxLength="350" Style="padding: 10px" />
                        </div>
                        <div class="clear-margin">
                            <div class="clear" style="height: 20px">
                            </div>
                            <asp:Button ID="btn_Add" runat="server" CssClass="input-buttons-create contact-update float-left margin-right"
                                OnClick="btn_Add_Clicked" Text="Add Inquire" Width="125px" style="margin-left: -12px;" />
                            <asp:Button ID="btn_Send" runat="server" CssClass="input-buttons-create contact-update float-left"
                                OnClick="btn_Send_Clicked" Text="Submit All" Width="125px" />
                            <div class="float-right">
                                <asp:Button ID="btn_ViewCurrent" runat="server" CssClass="input-buttons contact-update"
                                    OnClick="btn_View_Clicked" Text="View" Visible="false" />
                                <asp:Button ID="btn_Reset" runat="server" CssClass="input-buttons contact-update"
                                    OnClick="btn_Reset_Clicked" Text="Reset" />
                            </div>
                        </div>
                        <div class="clear-margin">
