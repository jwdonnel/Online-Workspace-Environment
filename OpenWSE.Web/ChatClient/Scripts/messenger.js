...
$(document).ready(function () {
    ...
    document.title = "Chatting with " + currUser;
});

function FindAndCreateEmoticons() {
    AjaxCall(pageUrl + "/GetEmoticons", '{ }', null, function (data) {
...
function isTyping(t) {
    if (!_isTypingCall) {
        _isTypingCall = true;
        AjaxCall(pageUrl + "/CallIsTyping", '{ "typing": "' + t + '","userto": "' + currUser + '" }', null, null, null, function (data) {
            _isTypingCall = false;
        });
    }
}
...
function postChatMessage() {
    ...
    if ((textbox.value == "Type message here...") || (textbox.value == "")) {
        ...
        if (!_isAddCall) {
            ...
            AjaxCall(pageUrl + "/CallAddMessage", '{ "message": "' + escape(textbox.value) + '","userto": "' + currUser + '" }', null, function (data) {
                if (data.d[0] != null) {
                    textbox.value = "";
...
function LoadFontStyles() {
    AjaxCall(pageUrl + "/LoadFontStyle", '{ }', {
        cache: false
    }, function (data) {
        if (data.d.length == 3) {
...
function LoadCustomFontFamily(url) {
    if (url != null && url != "" && url.indexOf(".css") != -1) {
...
function updateChatMessages() {
    if (!_isUpdateCall) {
        _isUpdateCall = true;
        AjaxCall(pageUrl + "/CallMessages", '{ "userto": "' + currUser + '","isPostBack": "' + isPostBack + '" }', {
            cache: false
        }, function (data) {
            if (data.d[0] != null)
...
function setChatMessages(msg) {
    ...
    if ((msg != "") && (msg != null) && (isPostBack == 1)) {
        ...
        for (var i = $(".chatLineSep").length - 1; i >= 0; i--) {
    ...
    if ((msg != "") && (msg != null) && (isPostBack == 0)) {
        ...
        var index = $(".chatLineSep").length - 1;
