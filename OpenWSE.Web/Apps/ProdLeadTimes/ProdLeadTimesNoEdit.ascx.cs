...
public partial class Apps_ProdLeadTimesNoEdit : UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lbl_lastrefreshed_pltviewer.Text = "<b class='pad-right'>Last Refresh</b>" + ServerSettings.ServerDateTime.ToString();
    ...
    protected void btn_update_pltviewer_Clicked(object sender, EventArgs e) {
        ...
        if (_prodLeadTime.pltcoll.Count > 0) {
            ...
            if ((dates != null) && (dates.Count > 0)) {
                ...
                line6 = _prodLeadTime.GetOverride("Override6")
                            ? Checkifoutofservice(_prodLeadTime.pltcoll[i].LaserTable)
                            : Checkifoutofservice(_prodLeadTime.pltcoll[i].LaserTable, dates[5]);
            }
        }
        else {
            line1 = "N/A";
        ...
        Label6_pltnoedit.Text = line6.Trim();
    ...
    private string BuildJS
    {
        get
        {
            ...
            str.Append("    openWSE.AjaxCall('Apps/ProdLeadTimes/GetPLT.asmx/GetTimes_ForViewer', '{ }', null, function (data) {");
            ...
            str.Append("            $('#Label6_pltnoedit').html(data.d[5]);");
            str.Append("            $('#lbl_timeupdated_pltnoedit').html(data.d[6]);");
            str.Append("            $('#lbl_updatedby_pltnoedit').html(data.d[7]);");
            str.Append("        }");
            str.Append("    });");
            str.Append("});");
