            ...
            <div class="Modal-element-modal" data-setwidth="565">
                ...
                <div class="ModalScrollContent">
                    <div class="ModalPadContent">
                        ...
                        <asp:Label ID="Label3" runat="server" Text="Account/Search" CssClass="modal-descDivs-item"></asp:Label>
                        <asp:TextBox ID="tb_twitteraccount" runat="server" CssClass="textEntry margin-right"
                            Width="95%"></asp:TextBox><span id="must-have-twitter-search" style="display: none; color: red;">*</span>
                        <div class="clear-space-five"></div>
                        <asp:Label ID="Label1" runat="server" Text="Title" CssClass="modal-descDivs-item"></asp:Label>
                        <asp:TextBox ID="tb_title" runat="server" CssClass="textEntry margin-right" Width="95%" MaxLength="150"></asp:TextBox>
                        <div class="clear-space-five"></div>
                        <asp:Label ID="Label2" runat="server" Text="Caption" CssClass="modal-descDivs-item"></asp:Label>
                        <asp:TextBox ID="tb_caption" runat="server" CssClass="textEntry margin-right-sml"
                            Width="95%" MaxLength="150"></asp:TextBox>
                        <div class="clear-space-five"></div>
                        <asp:Label ID="lbl_adding" runat="server" Text="Feed Type" CssClass="modal-descDivs-item"></asp:Label>
                        ...
                        <asp:Label ID="lbl_amountdisplay" runat="server" Text="Tweets to Display"
                            CssClass="modal-descDivs-item"></asp:Label>
                ...
                <div class="ModalButtonHolder">
                    <input id="btn_add" type="button" class="input-buttons modal-ok-btn" value="Add Feed" onclick="twitterStation.FinishAdd();" style="display: none;" />
                    <input id="btn_update" type="button" class="input-buttons modal-ok-btn" value="Update Feed" onclick="twitterStation.UpdateFeed();" style="display: none;" />
                    <input type="button" class="input-buttons modal-cancel-btn" value="Cancel" onclick="twitterStation.CloseModal();" />
                </div>
            </div>
        </div>
    </div>
