$(function () {
    ...
    var alarmClock = {
        ...
        start: function () {
            ...
            cookieFunctions.get("alarm-clock-controls_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), function (expanded) {
                ...
                cookieFunctions.get("alarm-clock_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), function (currentAlarm) {
                    if ((currentAlarm == "") || (currentAlarm == null) || (currentAlarm == undefined)) {
                        ...
                        cookieFunctions.get("alarm-clock-state_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), function (currentAlarmState) {
        ...
        set: function () {
            ...
            cookieFunctions.set("alarm-clock_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), $("#alarmclock-load").find("#ddl_alarmHour").val() + " " + $("#alarmclock-load").find("#ddl_alarmMinute").val() + " " + $("#alarmclock-load").find("#ddl_alarmSecond").val() + " " + $("#alarmclock-load").find("#ddl_alarmTimeOfDay").val(), 30, function () {
                cookieFunctions.set("alarm-clock-state_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), "on", 30, function () {
                    $("#alarmclock-load").find("#rbAlarmOn").prop("checked", true);
        ...
        turnOff: function () {
            cookieFunctions.set("alarm-clock-state_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), "off", 30, function () {
                $("#alarmclock-load").find("#rbAlarmOff").prop("checked", true);
                alarmClockVars.currentAlarmState = "off";
    ...
    $("#alarmclock-load").find("#minimize-controls").click(function () {
        if ($("#alarmclock-load").find("#setAlarm-holder").css("display") == "none") {
            ...
            cookieFunctions.del("alarm-clock-controls_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val());
        }
        else {
            ...
            cookieFunctions.set("alarm-clock-controls_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val(), "0", 30);
        }
    });
    ...
    $("#alarmclock-load").find("#btnResetAlarm").click(function () {
        openWSE.ConfirmWindow("Are you sure you want to reset the alarm clock? Reseting this deletes any cookies this app creates and sets all values back to the default.",
            function () {
                ...
                cookieFunctions.del("alarm-clock_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val());
                cookieFunctions.del("alarm-clock-state_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val());
                cookieFunctions.del("alarm-clock-controls_" + $("#alarmclock-load").find("#hf_currUser_AlarmClock").val());
                $("#alarmclock-load").find("#rbAlarmOff").prop("checked", true);
            }, null);
    });
