        ...
        if (userID.IsAuthenticated)
        {
            try
            {
                ...
                if (ce.calendar_dt.Count == 1)
                {
                    ...
                    string usercolor = "<div class='sch_ColorCode float-left rounded-corners-15' style='border:1px solid #DDD;margin-top:9px;filter:alpha(opacity=50);opacity:0.50;color:transparent;background-color:" + dr["ColorCode"] + "'></div>";
