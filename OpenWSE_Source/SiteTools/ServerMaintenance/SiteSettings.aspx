                    ...
                    <ContentTemplate>
                            ...
                            <asp:Panel ID="pnl_autoupdate" runat="server">
                                <div class="table-settings-box">
                                    ...
                                    <div class="td-settings-desc">
                                        Turning off the Auto Update System may cause some features to stop working, but might increase performance.
                                    </div>
                                </div>
                            </asp:Panel>
                            <div class="table-settings-box">
                        ...
                        <asp:Panel ID="pnl_admincontrolsonly" CssClass="pnl-section" runat="server" data-title="Administrative Settings" Visible="false" Enabled="false">
                            ...
                            <div class="table-settings-box">
                                ...
                                <div class="td-settings-desc">
                                    Select Yes to hide all app icons.
                                </div>
                            </div>
                                ...
                                <div id="rb_usersignup_holder" runat="server">
                                    ...
                                    <asp:Panel ID="pnl_socialSignIn_UserSignup" runat="server" Visible="false" Enabled="false">
                                        <div class="table-settings-box">
                                            ...
                                            <div class="td-settings-desc">
                                                Allow users to sign in using their Google+ accounts. <a href="https://developers.google.com/+/quickstart/csharp" target="_blank">Integration Information</a>
                                            </div>
                                        </div>
                                        <div class="table-settings-box">
                                            <div class="td-settings-title">
                                            ...
                                            <div class="td-settings-desc">
                                                Allow users to sign in using their Twitter accounts. <a href="https://dev.twitter.com/web/sign-in/implementing" target="_blank">Integration Information</a>
                                            </div>
                                        </div>
                                        <div class="table-settings-box">
                                            <div class="td-settings-title">
                                            ...
                                            <div class="td-settings-desc">
                                                Allow users to sign in using their Facebook accounts. <a href="https://developers.facebook.com/docs/facebook-login/login-flow-for-web/v2.2" target="_blank">Integration Information</a>
                                            </div>
                                        </div>
                                    </asp:Panel>
                            ...
                            <asp:Panel ID="pnl_meteTagCustomizations" runat="server">
                                ...
                                <div class="table-settings-box">
                                    ...
                                    <div class="td-settings-ctrl">
                                        ...
                                        <div class="clear-space-five"></div>
                                        <asp:LinkButton ID="lbtn_clearAllKeywordsMeta" runat="server" CssClass="RandomActionBtns"
                                            OnClick="lbtn_clearAllKeywordsMeta_Click">Clear</asp:LinkButton>
                                    </div>
                                    <div class="td-settings-desc">
                            ...
                            <asp:Panel ID="pnl_ImageCustomizations" runat="server" Enabled="false" Visible="false">
                                ...
                                <asp:Panel ID="pnl_loginTheme" runat="server">
                                    <div class="table-settings-box">
                                        ...
                                        <div class="td-settings-desc">
                                            Change the look of the site login screen.
                                        </div>
                                    </div>
                                </asp:Panel>
                            </asp:Panel>
