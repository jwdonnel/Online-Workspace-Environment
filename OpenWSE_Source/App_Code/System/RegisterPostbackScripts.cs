            ...
            if (vals.Length == 2) {
                ...
                if (!string.IsNullOrEmpty(appId)) {
                    ...
                    if (btn_uninstallApp != null && pnl_aboutHolder != null && updatepnl_aboutHolder != null) {
                        ...
                        if (type == "about") {
                            if (_member != null) {
                                if ((_member.UserHasApp("app-appinstaller")) && (!appId.Contains("app-ChatClient-"))
                                    && (appId.ToLower() != "app-appinstaller")) {
                            ...
                            if (ss.AllowAppRating) {
                                ...
                                returnVal = "openWSE.RatingStyleInit('.app-rater', '" + ratings.GetAverageRating(appId) + "', false, '" + appId + "', true);";
                            }
