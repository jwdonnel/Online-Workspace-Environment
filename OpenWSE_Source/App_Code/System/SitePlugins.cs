...
public class SitePlugins {
    ...
    public string GetPathLocation(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("SitePlugins", "PluginLocation", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
        return dbSelect.Value;
    }

    public void deleteItem(string id) {
        dbCall.CallDelete("SitePlugins", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }

    public void deleteItemForUser(string id) {
        dbCall.CallDelete("aspnet_UserPlugins", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }
}