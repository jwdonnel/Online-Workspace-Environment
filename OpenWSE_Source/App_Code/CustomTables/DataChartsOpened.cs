...
public class DataChartsOpened {
    ...
    public List<DataChartsOpened_Coll> GetAllUserChartsOpened() {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(TableName, "ID, AppID", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _userName) });
    ...
    public bool IsChartOpenedForUser(string appId) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle(TableName, "ID", new List<DatabaseQuery>() { new DatabaseQuery("UserName", _userName), new DatabaseQuery("AppID", appId) });
    ...
    public void DeleteItem(string appID) {
        dbCall.CallDelete(TableName, new List<DatabaseQuery>() { new DatabaseQuery("UserName", _userName), new DatabaseQuery("AppID", appID) });
    }

    public void DeleteItem(string appID, string username) {
        dbCall.CallDelete(TableName, new List<DatabaseQuery>() { new DatabaseQuery("UserName", username), new DatabaseQuery("AppID", appID) });
    }

    public void DeleteAllItemsForApp(string appID) {
        dbCall.CallDelete(TableName, new List<DatabaseQuery>() { new DatabaseQuery("AppID", appID) });
    }

    public void DeleteAllItemsForUser(string username) {
        dbCall.CallDelete(TableName, new List<DatabaseQuery>() { new DatabaseQuery("UserName", username) });
    }
