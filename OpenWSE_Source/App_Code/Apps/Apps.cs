...
public class App {
    ...
    public void BuildAboutApp(System.Web.UI.WebControls.Panel wlmd_holder, string appId, string username) {
        ...
        if (appId.Contains("app-ChatClient-")) {
            ...
            str.Append(imageIcon + "<div class='float-left'><h2 class='float-left pad-top'>" + OpenWSE.Core.Licensing.CheckLicense.SiteName + " Chat Client</h2>");
            ...
            str.Append("<b>About</b><div class='clear-space-two'></div>" + OpenWSE.Core.Licensing.CheckLicense.SiteName + " - " + DateTime.Now.Year + " John Donnelly<div class='clear-space'></div><div class='clear-space'></div>");
            ...
            if (db != null) {
                ...
                if (string.IsNullOrEmpty(about)) {
                    ...
                    about = OpenWSE.Core.Licensing.CheckLicense.SiteName + " | " + DateTime.Now.Year + " | " + tempuser;
                }
