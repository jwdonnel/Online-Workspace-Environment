...
public class AppRatings
{
    ...
    public void AddRating(string appId, string rating, string description) {
        ...
        query.Add(new DatabaseQuery("DateRated", DateTime.Now.ToString()));
    ...
    public void UpdateRating(string appId, string rating, string description) {
        ...
        updateQuery.Add(new DatabaseQuery("DateRated", DateTime.Now.ToString()));
    ...
    public List<AppRatings_Coll> GetAppRatings(string appId) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(_tableName, "", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appId) });
    ...
    public List<AppRatings_Coll> GetAllUserAppRatings(string userName) {
        ...
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(_tableName, "", new List<DatabaseQuery>() { new DatabaseQuery("UserName", userName) });
        foreach (Dictionary<string, string> dicVal in dbSelect) {
            string id = dicVal["ID"];
    ...
    public string GetAverageRating(string appId) {
        List<Dictionary<string, string>> dbSelect = dbCall.CallSelect(_tableName, "Rating", new List<DatabaseQuery>() { new DatabaseQuery("AppID", appId) });
