...
public class AppLogIgnore {
    ...
    public void deleteRecord(string id) {
        dbCall.CallDelete("aspnet_WebEvents_Ignored", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }

    public void deleteRecords() {
        dbCall.CallDelete("aspnet_WebEvents_Ignored", null);
    }
    ...
    public void UpdateRefreshOnError(string id, bool refreshOnError) {
        ...
        dbCall.CallUpdate("aspnet_WebEvents_Ignored", new List<DatabaseQuery>() { new DatabaseQuery("RefreshOnError", _refreshOnError.ToString()) }, new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }

    public bool GetRefreshOnError(string id) {
        DatabaseQuery dbSelect = dbCall.CallSelectSingle("aspnet_WebEvents_Ignored", "RefreshOnError", new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
        return HelperMethods.ConvertBitToBoolean(dbSelect.Value);
    }

    public void UpdateTimesHit(string id, int count) {
        dbCall.CallUpdate("aspnet_WebEvents_Ignored", new List<DatabaseQuery>() { new DatabaseQuery("TimesHit", count.ToString()) }, new List<DatabaseQuery>() { new DatabaseQuery("ID", id) });
    }
