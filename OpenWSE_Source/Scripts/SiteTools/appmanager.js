...
function AdjustEdit() {
    $("#App-element").find(".Modal-element-align").css({
        left: ($(window).width() - $("#App-element").find(".Modal-element-modal").width()) / 2,
        top: ($(window).height() - $("#App-element").find(".Modal-element-modal").height()) / 2,
        marginLeft: 0,
        marginTop: 0
    });
}
