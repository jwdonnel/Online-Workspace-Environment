...
var openWSE = function () {
    ...
    function LoadCreateAccountHolder() {
        if ($("#Login-holder").css("display") != "none") {
            $("#Login-holder").hide();
            $("#iframe-createaccount-holder").html("<iframe id='iframe-demo' src='SiteTools/iframes/CreateAccount.aspx' frameborder='0' width='550px' style='visibility: hidden;'></iframe>");
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.length == 2) {
                        ...
                        modal += "<div class='modal-inner-scroll'>" + data.d[1] + "</div>";
            ...
            success: function (data) {
                if (data.d != "") {
                    if ($("#app_title_bg").length == 0) {
                        ...
                        if (img.length > 6) {
                            $("#MainContent_bg_" + Getworkspace()).css("background", "#EFEFEF url('" + img + "') repeat top left");
                        }
                        else {
                        ...
                        if (img.length > 6) {
                            $("#app_title_bg").css("background", "#EFEFEF url('" + img + "') top left repeat");
                        }
                        else {
...
window.onerror = function (errorMsg, url) {
    ...
    if (url.toLowerCase().indexOf("networklog.aspx") != -1 && errorMsg == "Uncaught TypeError: boolean is not a function") {
        return;
    }
