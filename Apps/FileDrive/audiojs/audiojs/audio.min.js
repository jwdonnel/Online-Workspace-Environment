        ...
        trackEnded: function () {
            ...
            try {
                ...
                if ($document.find("#continue_play_hidden").val() != "false" || $document.find("#repeat_play_hidden").val() == "true") {
                    ...
                    var nextIndex = 0;
                    for (var i = 0; i < $document.find("#GV_Files_documents").find(".audio-file").length; i++) {
                        if (foundCurrent) {
                            nextIndex = i;
                            break;
                        }
                        else if ($document.find("#GV_Files_documents").find(".audio-file").eq(i).attr("data-src") == this.mp3) {
                            foundCurrent = true;
