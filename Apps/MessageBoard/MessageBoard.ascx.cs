...
public partial class Apps_MessageBoard_MessageBoard : System.Web.UI.UserControl
{
    ...
    private void UpdatePanel()
    {
        ...
        string script = "openWSE.GetScriptFunction('//tinymce.cachefly.net/4.1/tinymce.min.js', function() { TryLoadMBPage(); $('#Editor_messageboard_ifr').tooltip({ disabled: true }); });";
    ...
    private void LoadGroups()
    {
        ...
        if (dd_groups_messageboard.Items.Count > 0 && !GroupSessions.DoesUserHaveGroupLoginSessionKey(HttpContext.Current.User.Identity.Name)) {
